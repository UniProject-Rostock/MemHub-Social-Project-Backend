...
<div class="page-wrapper chiller-theme toggled">
    <nav id="sidebar" class="sidebar-wrapper">
        <div class="sidebar-content">
            ...
            <div class="sidebar-footer">
                <a style="cursor:pointer;" data-toggle="modal" data-target="#exampleModalCenter" type="button">
                    <i class="fa fa-bell"></i>
                    <span id="notification-counter" class="badge badge-pill badge-warning notification"></span>
                </a>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalCenterTitle">Benachrichtigungen</h5>
    ...
    <main class="page-content">
        ...
        <form action="/sharePost" method="post">
            <input type="text" hidden value="<%= request.getParameter("uid")%>" name="uid">
                        ...
                        <div class="card gedf-card">
                            ...
                            <div class="card-body">
                                <div class="tab-content" id="myTabContent">
                                    <div class="tab-pane fade show active" id="posts" role="tabpanel"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="inhalt" class="form-control" id="message" rows="3"
                                                      placeholder="Erinnerung verfassen..."></textarea>
                                        </div>
                                ...
                                <div class="btn-toolbar justify-content-between">
                                    <div class="btn-group">
                                        <button style="background-color: #00a1b2; color: white; width: 100px"
